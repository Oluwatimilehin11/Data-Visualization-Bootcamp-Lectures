...
df_fuel_types <- read.csv('C:/Users/phera/Desktop/Data Visualization/Pie_Charts/pie_charts.csv',
                          header = TRUE,
                          sep = ',')
...
pie_chart
cbpallete <- c('#999999','#E69F00','#56B4E9','#009E73','#F0E442','#0072B2','#D55E00','#CC79A7')
pie_chart <- pie_chart + scale_fill_manual (values = cbpallete)
